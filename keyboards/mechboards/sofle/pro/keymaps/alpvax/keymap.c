...
[_COLEMAK_DH] = LAYOUT(
    ...
    KC_LSFT,   KC_Z,   KC_X,   KC_C,   KC_D,   KC_V,UG_TOGG,     KC_MUTE,   KC_K,   KC_H,KC_COMM, KC_DOT,KC_SLSH,KC_RSFT,
...
[_GAME] = LAYOUT(
   MO(_ADJ),   KC_1,   KC_2,   KC_3,   KC_4,   KC_5,                        KC_6,   KC_7,   KC_8,   KC_9,   KC_0, KC_DEL,
     ...
     KC_TAB,KC_LSFT,   KC_A,   KC_S,   KC_D,   KC_F,                        KC_H,   KC_J,   KC_K,   KC_L,KC_SCLN,KC_QUOT,
       KC_Z,KC_LCTL,   KC_X,   KC_C,   KC_V,   KC_B,_______,     _______,   KC_N,   KC_M,KC_COMM, KC_DOT,KC_SLSH,KC_RSFT,
...
[_LOWER] = LAYOUT(
   ...
   _______, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                KC_CIRC,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,KC_NUHS,
    MO_EXT,  KC_EQL,KC_PLUS,KC_MINS,KC_LCBR,KC_RCBR,RM_TOGG,    _______,KC_LBRC,KC_RBRC,KC_SCLN,KC_COLN,KC_NUBS, MO_EXT,
                    _______,_______,_______,_______,_______,    _______,_______,_______,_______,_______
),
/* EXTEND
 * ,-----------------------------------------------.                    ,-----------------------------------------------.
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_COLEMAK_DH] = { ENCODER_CCW_CW(RM_NEXT, RM_PREV), ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    ...
    [_SHAW_1] = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS), ENCODER_CCW_CW(KC_TRNS, KC_TRNS)},
    // [_SHAW_2] = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS), ENCODER_CCW_CW(KC_TRNS, KC_TRNS)},
    ...
    [_EXTEND] = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS), ENCODER_CCW_CW(KC_TRNS, KC_TRNS)},
    [_ADJ] = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS), ENCODER_CCW_CW(KC_TRNS, KC_TRNS)}
};
#endif
