 ...
 * `---------------+-------+-------+-------+-------+-------|    |-------+-------+-------+-------+-------+---------------'
 *                 |  LGUI |  LAlt | LCTRL |/ NUBS/  Space |    |  Enter \RAISE\| RCtrl |  RAlt |  RGUI |
 *                 `-----------------------'-----'---------'     `--------'-----'-----------------------'
 */
[_GAME] = LAYOUT(
 ...
 * |       |       |       |       |       |       |                    |       |   D   |   E   |   F   |       |       |
 * |-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
 * |       |   ,   |   C   |   B   |   A   |   @   |                    |   C   |  Num7 |  Num8 |  Num9 |  KP_* |  KP_/ |
 * |-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
 * |       |  KP_/ |   .   |  KP_- |  KP_+ |  KP_= |                    |   B   |  Num4 |  Num5 |  Num6 |   .   |  KP_- |
 * |-------+-------+-------+-------+-------+-------|-------.    ,-------|-------+-------+-------+-------+-------+-------|
 * |       |  KP_* |   F   |   E   |   D   |   :   |  N/F  |    |  N/F  |   A   |  Num1 |  Num2 |  Num3 |   ,   |  KP_+ |
 * `---------------+-------+-------+-------+-------+-------|    |-------+-------+-------+-------+-------+---------------'
 *                 |       |       |       |/     /        |    |        \     \|  Num0 |       |       |
 *                 `-----------------------'-----'---------'     `--------'-----'-----------------------'
 */
[_NUMPAD] = LAYOUT(
    ...
    _______,KC_COMM,   KC_C,   KC_B,   KC_A,SFT_QOT,                        KC_C,KC_KP_7,KC_KP_8,KC_KP_9,KC_PAST,KC_PSLS,
    _______,KC_PSLS, KC_DOT,KC_PMNS,KC_PPLS,KC_PEQL,                        KC_B,KC_KP_4,KC_KP_5,KC_KP_6, KC_DOT,KC_PMNS,
    _______,KC_PAST,   KC_F,   KC_E,   KC_D,KC_COLN,_______,     _______,   KC_A,KC_KP_1,KC_KP_2,KC_KP_3,KC_COMM,KC_PPLS,
