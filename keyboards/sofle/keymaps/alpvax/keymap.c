...
[_NUMPAD] = LAYOUT(
    ...
    _______,_______,_______,_______,_______,_______,_______,     _______,   KC_A,KC_KP_1,KC_KP_2,KC_KP_3,KC_COMM,KC_PPLS,
...
[_LOWER] = LAYOUT(
  ...
  MO(_EXT),  KC_EQL,KC_PLUS,KC_MINS,KC_LCBR,KC_RCBR,_______,    _______,KC_LBRC,KC_RBRC,KC_SCLN,KC_COLN,KC_NUBS,MO(_EXT),
                    _______,_______,_______,_______,_______,    _______,_______,_______,_______,_______
),
/* EXTEND
 * ,-----------------------------------------------.                    ,-----------------------------------------------.
